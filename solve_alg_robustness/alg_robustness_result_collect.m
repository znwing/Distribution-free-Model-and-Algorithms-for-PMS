...
for sig_ratio = 0:4
    for k=1:Groups
        ...
        if k ==1
            ...
            Alg_Robustness_TPA_time(sig_ratio+1,k) = time(1,1) - Alg_Robustness_TPA_time(sig_ratio+1,k-1);
        end
    end
end
...
filename=strcat('./solve_alg_robustness/rubustness_results/Alg_Robustness_results_all_new.xlsx');
