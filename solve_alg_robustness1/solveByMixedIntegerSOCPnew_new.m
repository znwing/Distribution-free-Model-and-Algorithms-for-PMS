function [time,xval,yval,zval,objval,obj_bound,modeltime,solvetime,gap]=solveByMixedIntegerSOCPnew_new(m,n,halfsigma,pi,optionsgurobi,constraint,x,y,z,objective)
curtime=clock;
